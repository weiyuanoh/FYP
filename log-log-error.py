...
ref_line_2 = C_2 * 1/(ddof_array**2)

uniform_ddof = []
uniform_error = []
for l in range(3, 15):
    uniform_mesh = np.linspace(0.0,1.0, (2**l +1)) # 33 nodes 
    c_sol_uniform, f_vect_uniform = solve_scF_once(uniform_mesh, beta)
...
# plt.xlabel('Degrees of Freedom (ddof)', fontsize=14)
# plt.ylabel('Error', fontsize=14)
# plt.title('Log-Log Plot of Error vs. Degrees of Freedom', fontsize=16)
# plt.grid(True, which="both", linestyle="--", linewidth=0.5)
# plt.legend(fontsize=12)
# plt.show()
